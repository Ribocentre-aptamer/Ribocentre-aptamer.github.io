...
### 1. 全局搜索与筛选
- **搜索框**：支持按配体名称、年份、适配体名称、类型、类别等进行搜索
- **重置按钮**：一键清除所有筛选条件
- **数据计数**：实时显示当前筛选结果的数据量
...
- **数据更新**：
  1. 激活conda环境：`conda activate rna`
  2. 运行清洗脚本：`python excel_cleaner.py`
  3. 检查生成的JSON文件
