...
<!--iframe src="../plotly_pie.html" class="rounded-iframe" width="100%" height="1200" frameborder="0"></iframe-->
<!--div class="pie-chart">
  <div class="slice slice1">
    <div class="pie"><a href="#section1">Section 1</a></div>
  </div>
  <div class="slice slice2">
    <div class="pie"><a href="#section2">Section 2</a></div>
  </div>
  <div class="slice slice3">
    <div class="pie"><a href="#section3">Section 3</a></div>
  </div>
  <div class="slice slice4">
    <div class="pie"><a href="#section4">Section 4</a></div>
  </div>
  <div class="slice slice5">
    <div class="pie"><a href="#section5">Section 5</a></div>
  </div>
  <div class="slice slice6">
    <div class="pie"><a href="#section6">Section 6</a></div>
  </div>
</div-->
