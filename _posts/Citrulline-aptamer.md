---
layout: post
title:  "Citrulline aptamer, Arginine aptamer"
...
<font><p>Citrulline aptamer: A:5'-AGAAGGAGUGU-3'B:5'-ACGGUUAGGUCGCU-3'<br>Arginine aptamer: A:5'-AGAAGGAGCGU-3'B:5'-ACAGGUAGGUCGCU-3'</p></font>
<table class="table table-bordered" style="table-layout:fixed;width:1000px;margin-left:auto;margin-right:auto;"><tr>
  <td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/2D/Citrulline_aptamer_2D.svg" alt="drawing" style="width:500px;margin-top: 0px;margin-bottom: 0px;" >
  </td>
  <td style="text-align:center;padding-bottom: 0px;padding-right: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/2D/Arginine_aptamer_2D.svg" alt="drawing" style="width:500px;margin-top: 0px;margin-bottom: 0px;" >
  </td>
  </tr>
  </table>
...
},
{
  ...
  color:{r:255,g:255,b:0}
    ...
    <script>
      ...
      var options1 = {
        customData:{
        url:'/docs/pdbfiles/1KOC-3D-ARG.pdb',
        format: 'pdb'},
        expanded: false,
        hideControls: true,
        bgColor: {r:255, g:255, b:255},
...
<!--table class="table table-bordered" style="table-layout:fixed;width:1000px;margin-left:auto;margin-right:auto;" >
  ...
  <!--img src="/images/SELEX_ligand/Citrulline_SELEX_ligand.svg" alt="drawing" style="width:1000px;display:block;margin:0 auto;border:solid 1px;border-radius:0;" class="img-responsive"-->
  <img src="/images/SELEX_ligand/Arginine_SELEX_ligand.svg" alt="drawing" style="width:1000px;display:block;margin:0 auto;border:solid 1px;border-radius:0;" class="img-responsive">
<br><br>
