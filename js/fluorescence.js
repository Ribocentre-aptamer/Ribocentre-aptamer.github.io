/**
 * fluorescence.js - 为Fluorescence页面轮播图设计的专用JS
 */

// 轮播图模块
const FluorescenceCarousel = {
    currentSlideIndex: 0,
    slides: null,
    dots: null,
    totalSlides: 0,
    ...
    init() {
        console.log('Fluorescence轮播图初始化...');
...
// 导出全局函数，供HTML调用
window.nextSlide = () => FluorescenceCarousel.nextSlide();
window.prevSlide = () => FluorescenceCarousel.prevSlide();
window.currentSlide = (index) => FluorescenceCarousel.currentSlide(index);
